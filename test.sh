...
python -m eva_scripts.leaderboard_scenarios --EXP_TITLE full_exp_jan --EVA_MODE create --SCENARIOS adv_start_point_scenario
...
python -m eva_scripts.leaderboard_scenarios --EXP_TITLE full_exp_jan --EVA_MODE create --SCENARIOS start_point_scenario
