...
OGAL provides 50+ AL strategies from 5 frameworks under a unified API. This page covers strategy families, how to pick strategies, and known constraints.
...
## Export Full Catalog Programmatically
...
??? info "How Strategy Dispatch Works"
    OGAL dispatches a workload item to the correct strategy:
