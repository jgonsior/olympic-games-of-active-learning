...
class SAMPLES_CATEGORIZER(IntEnum):
    ...
    CLOSENES_TO_CLUSTER_BORDER = 9
    IMPROVES_ACCURACY_BY = 10
    EASY_TO_CLASSIFY_CATEGORIZER = 11
...
samples_categorizer_to_classes_mapping: Dict[SAMPLES_CATEGORIZER, Callable] = {
    ...
    SAMPLES_CATEGORIZER.CLOSENES_TO_CLUSTER_BORDER: CLOSENES_TO_CLUSTER_BORDER,
    SAMPLES_CATEGORIZER.IMPROVES_ACCURACY_BY: IMPROVES_ACCURACY_BY,
    SAMPLES_CATEGORIZER.EASY_TO_CLASSIFY_CATEGORIZER: EASY_TO_CLASSIFY_CATEGORIZER,
}
