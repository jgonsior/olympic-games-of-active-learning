...
# wenn metric file -> delete it, recalculate it
# wenn originales file: über andere artverwandte datei herausfinden, was die EXP_IDs sind die fehlen
# dann in done_workload_csv herausfinden, was das experiment war
# dann genau diese exp_ids überall herauslöschen wo sie sind
# dann genau das experiment neu starten wie in den 02c_ skripten
# dann happy?
-> anscheinen dNUR ein Problem von all_strat???
--> brauch ich daher gar nicht, hehe
